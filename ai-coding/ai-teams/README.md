...
- **[📊 流程指南](../SDLC_Workflow_Guide.md)** - SDLC全流程指南（新项目、二次开发、测试、运维等）
- **[🎮 角色卡片](./role-cards.html)** - 18个SDLC智能助手角色展示
...
- **[visualization-expert.md](./visualization-expert.md)** - 可视化专家
  - 时序图生成
  - 架构图与流程图
  - Canvas交互式动画
  - 技术对比可视化
...
### 0. 查看完整流程
在开始使用具体角色前，建议先查看 **[📊 SDLC全流程指南](../SDLC_Workflow_Guide.md)**，了解：
- 从零到一的新项目开发流程
- 基于现有代码的二次开发
- 测试、安全、运维等各个阶段
- 每个阶段需要哪些角色配合
...
- **📊 流程指南**：[SDLC_Workflow_Guide.md](../SDLC_Workflow_Guide.md) - 完整的SDLC流程指导
- **🎮 角色卡片**：[role-cards.html](./role-cards.html) - 18个智能角色可视化展示
- **📝 原始文档**：[SDLC_Prompts_Table.html](../SDLC_Prompts_Table.html) - 提示词表格原文档
- **👥 适用团队**：50+ 人的大型研发团队
